...
from anaconda_navigator.config.base import get_conf_path, get_home_dir, is_gtk_desktop, is_ubuntu
...
ANACONDA_ORG_BRAND = 'Anaconda.org'
NUCLEUS_BRAND = 'Anaconda Nucleus'
ENTERPRISE_EDITION_BRAND = 'Enterprise 4 Repository'
TEAM_EDITION_BRAND = 'Team Edition'
COMMERCIAL_EDITION_BRAND = 'Commercial Edition'
DEFAULT_BRAND = ANACONDA_ORG_BRAND
