...
if typing.TYPE_CHECKING:
    ...
    class SelectorInitializer(typing_extensions.Protocol):
...
class EnvironmentsComponent(common.Component):
    ...
    def check_for_new_environments(self):
        ...
        def listener(worker: typing.Any, output: typing.Any, error: str) -> None:
    ...
    def show_backup_environment(self) -> None:
        ...
        environment_name: str = '{name}_{date}'.format(
            name=os.path.basename(self.main_window.current_prefix),
    ...
    def show_import_environment(self) -> None:
        """"""
        ...
        while True:
            ...
            if dialog.outcome == environment_dialogs.SelectorOutcome.ACCEPT:
                old_prefix: typing.Optional[str] = dialog.conda_details.environments.get(dialog.environment_name, None)
                new_prefix: str = (
                    old_prefix
                    or os.path.join(dialog.conda_details.environment_directories[0], dialog.environment_name)
                )
                file: str = dialog.environment_specification
                file_temporary: bool = dialog.environment_temporary
                ...
                def env_import(*args: typing.Any) -> None:
                    self.main_window.set_busy_status(conda=True)
                ...
                def cleanup(*args: typing.Any) -> None:
                    if file_temporary:
                        try:
                            os.remove(file)
                        except OSError:
    ...
    def show_conda_packages_action(self, conda_packages_actions, pip_packages_actions) -> None:
    ...
    def update_style_sheet(self, style_sheet: typing.Any) -> None:
        ...
        self.__tab.update_style_sheet(style_sheet=style_sheet)
