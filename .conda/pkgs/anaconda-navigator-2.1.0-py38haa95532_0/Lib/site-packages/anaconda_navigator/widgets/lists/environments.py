...
class BaseListItemEnv(ListWidgetItemBase):
    ...
    ENV_ITEM_WIDTH = SASS_VARIABLES.WIDGET_ENVIRONMENT_TOTAL_WIDTH
    ENV_ITEM_HEIGHT = SASS_VARIABLES.WIDGET_ENVIRONMENT_TOTAL_HEIGHT

    def __init__(self, name=None, prefix=None):
        """Widget to build an item for the environments list."""
        super(BaseListItemEnv, self).__init__()
...
class ListWidgetEnv(BaseListWidgetEnv):
    """Custom list widget environments."""
...
class ListItemEnv(BaseListItemEnv):
    ...
    def __init__(self, name=None, prefix=None):
        """Widget to build an item for the environments list."""
        super(ListItemEnv, self).__init__(name=name, prefix=prefix)
