...
class SelectorForm(QtCore.QObject):
    ...
    def __setitem__(self, value: SelectorValue, option: SelectorOption) -> None:
        ...
        def register_change(checked: bool):
            if checked:
                self.__value = value
...
class SelectorDialog(dialogs.DialogBase):
    ...
    def __init__(self, parent: typing.Optional[QtWidgets.QWidget] = None) -> None:
        ...
        self.__progress_bar: typing.Optional[QtWidgets.QProgressBar] = None
    ...
    def __init_actions__(
        ...
        self.__progress_bar: 'typing_extensions.Final[QtWidgets.QProgressBar]' = progress_frame.progress_bar

        # Buttons
        self.__reject_button: 'typing_extensions.Final[QtWidgets.QPushButton]' = widgets.ButtonNormal()
        self.__reject_button.setText(reject_text)
        self.__reject_button.clicked.connect(self._process_reject)

        self.__accept_button: 'typing_extensions.Final[QtWidgets.QPushButton]' = widgets.ButtonPrimary()
    ...
    def set_rejectable(self, state=True) -> None:
...
class PrepopulatedSelectorDialog(SelectorDialog):
    ...
    def __init_header__(
        ...
        self.__heading_errors: 'typing_extensions.Final[QtWidgets.QVBoxLayout]' = QtWidgets.QVBoxLayout()
    ...
    def __init_nucleus_form__(self, form: SelectorForm) -> None:
        ...
        self.__nucleus_account: 'typing_extensions.Final[QtWidgets.QLabel]' = widgets.LabelBase()
    ...
    def __init_footer__(
        ...
        self.__environment_name: 'typing_extensions.Final[common.LineEditEnvironment]' = common.LineEditEnvironment()
        self.__environment_name.textChanged.connect(self._process_environment_name)

        self.__environment_override: 'typing_extensions.Final[widgets.CheckBoxBase]' = widgets.CheckBoxBase()
        ...
        self.__footer_error: 'typing_extensions.Final[common.WarningLabel]' = common.WarningLabel()
    ...
    def add_heading_error(self, value: str) -> None:
        ...
        self.__heading_errors.addWidget(common.WarningBlock(text=value))
    ...
    def _handle_header_error(
            ...
            message_content: str,
            message_type: MessageType = MessageType.FALLBACK,
    ) -> typing.Callable[[BaseException], bool]:
    ...
    def _handle_nucleus_login_required(self) -> typing.Callable[[BaseException], bool]:
