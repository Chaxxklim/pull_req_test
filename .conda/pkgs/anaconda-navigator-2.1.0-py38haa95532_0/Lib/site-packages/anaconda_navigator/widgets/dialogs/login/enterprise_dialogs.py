...
from anaconda_navigator.config import ENTERPRISE_EDITION_BRAND
...
from anaconda_navigator.static.images import ANACONDA_ENTERPRISE_EDITION_LOGIN_LOGO
from . import styling
...
ENTERPRISE_LOGIN_TEXT_CONTAINER = TextContainer(
    ...
    info_frame_logo_path=ANACONDA_ENTERPRISE_EDITION_LOGIN_LOGO,
)
...
class NoticePage(StaticDialogBase):
    ...
    def __init__(
        ...
        self.tracker: GATracker = GATracker()
...
class EnterpriseRepoLoginPage(BaseLoginPage):
    ...
    def __init__(self, parent: typing.Optional[QWidget] = None) -> None:
        ...
        self.api_url_config_option = 'enterprise_4_repo_api_url'
        self.brand = ENTERPRISE_EDITION_BRAND
